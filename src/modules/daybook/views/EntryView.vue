<template>
  ...
  <Fab icon="fa-save" />
  <img
    src="https://cdn.vox-cdn.com/thumbor/i8VMIYJR6tAE2v5XIvpsBbEYkpc=/800x0/filters:no_upscale()/cdn.vox-cdn.com/uploads/chorus_asset/file/22661965/img19.jpg"
    alt="entry-picture"
    class="img-thumbnail"
  />
</template>
...
export default {
  components: {
    Fab: defineAsyncComponent(() =>
      import(/* webpackChunkName: "Fab" */ "../components/Fab.vue")
    ),
  },
};
</script>
